...
/**
 * Executes database upgrades for Video Lesson.
 *
 * The initial release has no upgrade steps because its schema is created by
 * db/install.xml. Future versions should add ordered savepoints here.
 *
